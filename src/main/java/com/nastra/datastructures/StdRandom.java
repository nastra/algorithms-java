...
public final class StdRandom {
     ...
     * 
     * @throws IllegalArgumentException
     *             if either <tt>p < 0.0</tt> or <tt>p > 1.0</tt>
     */
    ...
    /**
     * Returns a number from a discrete distribution: i with probability a[i]. throws IllegalArgumentException if sum of array entries is not (very
     * nearly) equal to <tt>1.0</tt> throws IllegalArgumentException if <tt>a[i] < 0.0</tt> for any index <tt>i</tt>
     */
