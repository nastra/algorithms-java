 ...
 * storing all positive integers. <br>
 * This is a solution to the following interview question: <br>
 * "Given an input file with four billion non-negative integers, provide an algorithm to generate an integer which is not contained in the file.<br>
