...
/**
 * Given two (dictionary) words as Strings, determine if they are isIsomorphic.
 * Two words are called isIsomorphic if the letters in one word can be remapped
...
public class Isomorphic {
    ...
    /**
     * Algorithm runs in time O(n+m) where n is the length of the first string
     * and m is the string of the second string. To be isomorphic, both strings
     * need to have the same length. The algorithm requires O(n+m) space in the
     * worst case.
     * 
     * @param one
     * @param two
