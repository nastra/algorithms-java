 ...
 * 'Design an efficient algorithm that takes an array A of n numbers and returns the number of inverted pairs of indices.' <br>
 * <br>
 ...
 * 
 * <br>
 * So in order to solve the problem, we basically can use merge countInversions. The strategy is as following: When there is an element a[j] that is
 * larger than a[i], we know that the rest of the elements residing in the array from i..mid are also inversions. Therefore we simply take (mid + 1 -
